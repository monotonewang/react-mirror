...
export default class ConditionalRendering extends React.Component {
    ...
    guestLogin() {
        ...
        return <h1 onClick={this.handlerGuestLogin()}>guest login</h1>;
    }

    guestLogined() {
        return <div>
            {/*<h2 onClick={this.handlerGuestLogin()}><font color="#0000FF">Helllo GUEST LOGINED</font></h2>;*/}
            <h1 onClick={this.handlerGuestLogOut()}><font color="#0000FF">Helllo GUEST logout</font></h1>;
        </div>;
    }
